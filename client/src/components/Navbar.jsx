...
function Navbar() {
  ...
  return (
    <div id="navbar-container" className="fixed top-0 z-10 w-full bg-[#50936d] h-[4rem] flex items-center justify-center text-white text-lg drop-shadow-md">
      <div className="container flex items-center justify-between px-8 h-full">
        ...
        <div className="hidden sm:flex sm:items-center font-semibold sm:ml-6">
          <Link to="/exams" className="flex items-center px-[0.75rem] py-2 rounded-md text-white hover:bg-[#266140] bg-[#2e7c4d]">
            EXAMS
          </Link>
          <Link to="/admin" className="flex items-center px-[0.75rem] py-2 ml-4 text-white bg-[#2e7c4d] hover:bg-[#266140] rounded-md">
            ADMINISTRATION
          </Link>
        </div>
