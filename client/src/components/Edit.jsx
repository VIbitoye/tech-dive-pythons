          ...
          <div className="flex flex-col items-center justify-center">
            {!editMode && (
              <>
                ...
                <div className="flex flex-col items-center justify-center">
                  <button
                    className="bg-[#2c73e6] text-white active:bg-blue-600 font-bold uppercase text-xs px-6 py-3 rounded-full shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                    type="button"
                  ...
                  <div className="flex flex-col  md:flex-row items-center justify-center gap-10 h-auto bg-white drop-shadow-lg rounded-md border-2 md:px-10 md:py-10 mt-6">
                    <img
                      className="w-full md:w-1/2 rounded-lg sm:max-h-[25rem] md:max-h-[40rem]"
                      src={exam.pngFileName}
                      alt="x-ray photo"
                    />
                    ...
                    <div className="flex flex-col sm:w-2/3 md:w-1/2 md:px-10 md:py-5 md:grid md:grid-cols-2 md:gap-5 ">
                      <div className="border-2 bg-white rounded-lg drop-shadow-lg mb-2">
                        ...
                        <Link to={`/patient/${exam.patientId}`}>
                          <p className="px-4 font-semibold py-2 text-green-500">
                            {exam.patientId}
                          </p>
                        </Link>
                      </div>
                      ...
                      <div className="border-2 bg-white rounded-lg drop-shadow-lg mb-2">
                        <p className="font-medium px-4 py-2">
                          Admitted to ICU:
                        </p>
            ...
            {editMode && (
              ...
              >
                ...
                <div className="col-span-1">
                  ...
                  <label className="block mb-2 font-medium text-gray-600">
                    ...
                    <input
                      ...
                      value={
                        formValues.icu === "Y"
                          ? Math.max(formValues.numIcuAdmits || 1, 1)
                          : 0
                      }
                      onChange={handleInputChange}
                      className="border-2 border-gray-300 p-2 rounded-md w-full"
                ...
                <div className="col-span-2">
                  ...
                  <button
                    className="ml-4 px-4 py-2 rounded-md text-white bg-red-500 hover:bg-red-600"
